...
To join a performance, please use your device's web browser to access your unique ticket URL and select the "Join Room" button. If specifically using PCVR, there is a second button to "Enter on PCVR" for additional instructions.  
...
> - [SteamVR](https://store.steampowered.com/app/250820/SteamVR/) | *Open SteamVR and Browser and select "Enter on PCVR" 
