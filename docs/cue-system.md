...
7. [Cueing Types and Samples](#cueing-types-and-samples)
    1. [Load Objects](#load-objects)
        a. [spawn_item](#spawn_item)
        b. [spawn_prop](#spawn_prop)
        c. [load_360_image](#load_360_image)
        d. [spawn_360_gif](#spawn_360_gif)
        e. [share_camera](#share_camera)
        f. [socket_spwan_object](#socket_spawn_object)
    2. [Delete Objects](#delete-objects)
        a. [delete](#delete)
    3. [Object Commands](#object-commands)
        a. [play_360_gif](#play_360_gif)
        b. [remote_scale_audio](#remote_scale_audio)
        c. [remote_morph_audio](#remote_morph_audio)
        d. [change_material_color](#change_material_color)
        e. [remove_interaction](#remove_interaction)
        f. [apply_gravity](#apply_gravity)
    4. [Animations](#animations)
        a. [move](#move)
        b. [track_object](#track_object)
        c. [recall_audience](#recall_audience)
        d. [manipulate_skybox_360](#manipulate_skybox_360)
        e. [socket_manipulate_object](#socket_manipulate_object)
        f. [socket_fade_skybox_opacity](#socket_fade_skybox_opacity)
        g. [change_animation](#change_animation)
        h. [lock_waypoint](#lock_waypoint)
        i. [theatre_animation](#theatre_animation)
    5. [Avatar Commands](#avatar-commands)
        a. [jump_to_waypoint](#jump_to_waypoint)
        b. [change_avatar](#change_avatar)
        c. [manipulate_avatar](#manipulate_avatar)
        d. [avatar_change_back](#avatar_change_back)
        e. [hop_to_spawn_point](#hop_to_spawn_point)
    6. [Settings and Permissions](#settings-and-permissions)
        a. [socket_toggle_flight](#socket_toggle_flight)
        b. [socket_toggle_movement](#socket_toggle_movement)
        c. [change_rolloff](#change_rolloff)
    7. [Meta Cueing](#meta-cueing)
        a. [call_global_function](#call_global_function)
        b. [webapp_cue](#webapp_cue)
        c. [avatar_sheets](#avatar_sheets)
